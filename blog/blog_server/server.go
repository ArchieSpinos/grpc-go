...
type blogItem struct {
	ID       primitive.ObjectID `bson:"_id,omitpempty"`
...
func (*server) DeleteBlog(ctx context.Context, req *blogpb.DeleteBlogRequest) (*blogpb.DeleteBlogResponse, error) {
	...
	if res.DeletedCount < 1 {
		fmt.Printf("have deleted nothing")
	}
...
func main() {
	...
	// Mongo client
	client, err := mongo.NewClient(options.Client().ApplyURI("mongodb://root:secret@localhost:27017"))
	if err != nil {
		log.Fatal(err)
	}
